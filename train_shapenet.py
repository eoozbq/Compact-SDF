...
def main_function(experiment_directory, continue_from):
    ...
    sdf_dataset = deep_sdf.gl_data.shapenet_data(
    ...
    # smooth_loss_l1 = torch.nn.(reduction="sum")
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        for global_data, cube_data, indices in sdf_loader:
            ...
            sdf_g_loss = loss_l1(pred_g_sdf, sdf_g_gt.cuda()) / num_global_sdf_samples
            sdf_l_loss = loss_l1(pred_l_sdf, sdf_l_gt.cuda()) / num_cube_samples
            ...
            formatted_output = f"Chunk Loss: {chunk_loss:.10f}, deepsdf_sdf_loss: {sdf_g_loss:.10f}, cube_sdf_loss: {sdf_l_loss:.10f},  Reg Loss: {reg_loss:.10f},  reg_loss_cube: {reg_loss_cube:.10f}"

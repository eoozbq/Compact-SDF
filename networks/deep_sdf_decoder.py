...
class NGP_SdfDecoder(nn.Module):
    def __init__(self, latent_size=256, hidden_dim=512,
        ...
        self.encoding = tcnn.Encoding(
            ...
            encoding_config={
                ...
                "base_resolution": 16,
                "per_level_scale": 1.174,
            }
        )
        self.input_size = input_size + self.encoding.n_output_dims
...
class ours_decoder(nn.Module):
    def __init__(
            self,
            latent_size,
            world_size,
    ):
        super(ours_decoder, self).__init__()
